...
function SessionTree({
  ...
  }, [list, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, effectiveUpdatedAt, ungroupedSessionIds, workspaces])
...
>) {
  ...
  }, [list, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, effectiveUpdatedAt, sessionIds, syncSessionOrderAccount])
  const rows = useMemo(() => {
