...
/**
* Package-owned invariant companion for `@deepseek-ai/dsh-client-chat-actions`.
* @module @deepseek-ai/dsh-client-chat-actions/invariant
*/
const PACKAGE_NAME = "@deepseek-ai/dsh-client-chat-actions";
